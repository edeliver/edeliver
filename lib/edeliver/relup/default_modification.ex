defmodule Edeliver.Relup.DefaultModification do
  @moduledoc """
    ...
    instructions. It is used unless a `Edeliver.Relup.Modification`
  ...
  @doc """
    Returns the priority `Edeliver.Relup.Modification.priority_default/0`. Unless the module is set by the
